...
- [odin_custom_boot_1.0.3.7z](https://github.com/imperador/OdinMultiBootGuides/releases/download/Downloads/odin_custom_boot_1.0.3.7z)

- [odin_windows_installer.7z](https://github.com/imperador/OdinMultiBootGuides/releases/download/Downloads/odin_windows_installer.7z)

- Sensor Config Driver if you have **Model: Odin_M2** [qcSensorsConfig850-M2.zip](https://github.com/imperador/OdinMultiBootGuides/releases/download/Downloads/qcSensorsConfig850-M2.zip)

- An install.wim from either folder in this (to add) [link](https://download.project-valhalla.com/windows_release/). 
